...
struct process_t {
    ...
    struct execution_context_t saved_context; // Saved context for parent restoration
};
...
struct process_t *process_get(u32 pid);
struct process_t *process_get_current(void);
void process_set_current(u32 pid);

// Context switching functions
void process_save_context(u32 pid, struct execution_context_t *context);
